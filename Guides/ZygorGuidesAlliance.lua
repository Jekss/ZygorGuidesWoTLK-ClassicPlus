...
startlevel 1
	...
	step //23
		.' Enter the troll cave|goto 26.8,79.8,0.5|q 218
	step //24
		.' Follow the path on the left to|at 30.5,80.2
	...
	step //33
		.' Go through the tunnel to the other side|goto Dun Morogh,35.6,65.8,0.3|noway|q 420
	step //34
		goto 46.7,53.8
	...
	step //53
		goto 37.9,42.1|n
		.' The path up to Shimmerweed starts here|goto Dun Morogh,37.9,42.1,0.3|noway|q 315
	step //54
		goto 41.2,36.4
		.from Frostmane Seer##1397+
		.' Click the Shimmerweed Baskets
	...
	step //63
		goto 21.2,52.3
		.' Explore Frostmane Hold|goal Fully explore Frostmane Hold|q 287/1
	...
	step //65
		ding 9
	step //66
		.' Hearth to Kharanos|goto Dun Morogh,47.3,52.5,0.5|use Hearthstone##6948|noway|q 412
	step //67
		goto 45.8,49.4
		.talk Razzle Sprysprocket##1269
	...
	step //71
		goto 59.8,50.0|n
		.' The path up to Protecting the Herd starts here|goto Dun Morogh,59.8,50.0,0.5|noway|q 314
	step //72
		goto 62.6,46.1
		.from Vagash##1388
	...
	step //80
		...
		only Gnome Warrior
	step //81
		.' Go northeast to Ironforge|goto Ironforge|noway|q 1679
		only Gnome Warrior
	step //82
		...
		only Gnome Warrior
	step //83
		.' Go outside to Dun Morogh|goto Dun Morogh|noway|q 1678
		only Gnome Warrior
	step //84
		goto Dun Morogh,27.8,58
		.from Vejrek##6113
		.get Vejrek's Head##6799|q 1678/1
		only Gnome Warrior
	step //85
		.' Go northeast to Ironforge|goto Ironforge|noway|q 1678
		only Gnome Warrior
	step //86
		goto Ironforge,70.8,90.3
		.talk Muren Stormpike##6114
		...
		only Gnome Warrior
	step //87
		.' Go outside to Dun Morogh|goto Dun Morogh|noway|q 413
		only Gnome Warrior
	step //88
	...
	step //89
		.' Go southeast to Loch Modan|goto Loch Modan|noway|q 414
	step //90
		goto Loch Modan,33.9,51
		.talk Thorgrum Borrelson##1572
		.fpath Thelsamar
	step //91
		.' Fly to Ironforge|goto Ironforge|noway|q 1715 |future
		only Gnome Warlock
	step //92
	...
	step //93
		goto 76.9,51.2
		.' Ride the tram to Stormwind City|goto Stormwind City|noway|q 1715
		only Gnome Warlock
	step //94
		goto Stormwind City,39.2,85.3
		.talk Gakin the Darkbinder##6122
	...
	step //101
		goto 69,30.9
		.' Ride the train to Ironforge|goto Ironforge|noway|q 414
		only Gnome Warlock
	step //102
		.' Fly to Thelsamar|goto Loch Modan,33.9,50.8,0.5|noway|q 414
		only Gnome Warlock
	step //103
	...
	step //118
		goto 33.9,51
		.talk Thorgrum Borrelson##1572
		.' Fly to Ironforge|goto Ironforge|noway|q 291
	step //119
	...
	step //120
		goto 76.9,51.2|n
		.' Ride the train to Stormwind|goto Stormwind City|noway|q 1338
	step //121
		goto Stormwind City,64.6,37.2
		.talk Furen Longbeard##5413
		..turnin Stormpike's Order##1338
	...
	step //132
		...
		.' Click the Beached Sea Creature
		.info It looks like a big green rotting dinosaur laying on the beach.
		.collect Sea Creature Bones##12242|q 3524/1
	step //133
		goto 36.7,46.3
...
startlevel 1
	...
	step //23
		...
		..accept The Stolen Journal##218
	step //24
		.' Go into the cave at 26.8,79.8|goto 26.8,79.8|q 218
	step //25
		goto 30.5,80.2
		.from Grik'nir the Cold##808
		.get Grelin Whitebeard's Journal##2004|q 218/1
	...
	step //28
		...
		..accept Scalding Mornbrew Delivery##3364
	step //29
		goto Dun Morogh,28.8,69.8|n
		.' Go northeast to Anvilmar|goto Dun Morogh,28.8,69.8,0.5|noway|q 3361
	step //30
		goto 28.5,67.7
		.talk Felix Whindlebolt##8416
		..turnin A Refugee's Quandary##3361
	...
	step //34
		...
		..accept Supplies to Tannok##2160
	step //35
		goto Dun Morogh,35.6,65.8|n
		.' Go through the tunnel to the other side|goto Dun Morogh,35.6,65.8,0.5|noway|q 420
	step //36
		goto 46.7,53.8
		.talk Senir Whitebeard##1252
		..turnin Senir's Observations (2)##420
	...
	step //55
		goto 37.9,42.1|n
		.' The path up to Shimmerweed starts here|goto Dun Morogh,37.9,42.1,0.5|noway|q 315
	step //56
		goto 41.2,36.4
		.collect 6 Shimmerweed##2676|q 315/1
		.info The Shimmerweed Baskets look like woven wooden baskets on the ground around this area.
	...
	step //59
		goto 47.3,52.3
		.talk Innkeeper Belm##1247
		.buy 1 Thunder Ale##2686|q 310 |future
	step //60
		goto 47.6,52.7
		.talk Jarven Thunderbrew##1373
		.' Give him the Thunder Ale
	...
	step //79
		...
		..turnin Those Blasted Troggs!##432
	step //80
		.' Hearth to Kharanos|goto Dun Morogh,47.4,52.5,0.5|use Hearthstone##6948|noway|q 413
	step //81
		ding 10
	step //82
		goto 47.4,52.6
	...
	step //96
		...
		only Dwarf Hunter
	step //97
		.' Go northeast to Ironforge|goto Ironforge|noway|q 6086
		only Dwarf Hunter
	step //98
	...
	step //107
		...
		.from Tunnel Rat Scout##1173, Tunnel Rat Forager##1176, Tunnel Rat Kobold##1202, Tunnel Rat Vermin##1172
		.get 12 Tunnel Rat Ear##3110|q 416/1
		.' You can find more Kobold|at 26.15,43.45
	step //108
		ding 11
	step //109
		goto 24.8,18.4
	...
	step //132
		goto 32.4,43.8|n
		.' Ride the boat to Stormwind Harbor|goto Stormwind City|noway|q 1646 |future
		only Dwarf Paladin
	step //133
		goto 69,30.9|n
		.' Ride the train to Ironforge|goto Ironforge|noway|q 1646 |future
		only Dwarf Paladin
	step //134
	...
	step //136
		...
		only Dwarf Paladin
	step //137
		.' Go outside to Dun Morogh|goto Dun Morogh|noway|q 1779
		only Dwarf Paladin
	step //138
...
startlevel 13
	...
	step //36
		goto 57.1,19.3
		.' Click the Sack of Oats (if it's not there, wait a few minutes, it will reappear).
		.info This is where I get my first Sack of Oats for "Poor Old Blanchy".  Get the rest of them as you see them around Westfall.
	...
	step //37
		...
		.' You can find more gnolls|at 52.4,16.2
	step //38
		goto 55.1,12.3
	...
	step //48
		...
		.' Ride the boat to Auberdine|goto Darkshore|noway|q 4811 |future
	step //49
...
startlevel 20
	step //1
		goto Redridge Mountains,40.35,46.5
		.from Murloc Flesheater##422, Murloc Shorestriker##1083, Murloc Minor Tidecaller##548
		.get 10 Spotted Sunfish##1467|q 127/1
		.collect 8 Murloc Fin##1468|q 150 |future
		.' You can find more murlocs around (1)|at 48.2,73.3
		.' You can find more murlocs around (2)|at 56.45,52.87
		.' You can find more murlocs around (3)|at 58.05,60.15
	step //2
		goto 55.5,74.7
	...
	step //4
		.' Hearth to Lakeshire|goto Redridge Mountains,26.9,44.9,0.5|use Hearthstone##6948|noway|q 20
	step //5
		.' Fly to Stormwind|goto Stormwind City|noway|c
	...
	step //15
		...
		.collect Heartswood##6912|q 1738/1
		.info It's a tall tree.
		only Gnome Warlock,Human Warlock
	step //16
	...
	step //18
		...
		only Gnome Warlock,Human Warlock
	step //19
		.' Go downstairs into the crypt to|goto 22.1,84.4
	...
	step //28
		goto 30.6,59.4|n
		.talk Ariena Stormfeather##931
		.' Fly to Sentinel Hill|goto Westfall,56.5,52.7,0.5|noway|q 103 |future
	step //29
		goto 52.9,53.7
		.talk Innkeeper Heather##8931
		home Sentinel Hill|q 103 |future
	step //30
	...
	step //34
		ding 21
	step //35
		.' Hearth to Sentinel Hill|goto Westfall,53.4,50.8,3|use Hearthstone##6948|noway|q 142
	step //36
		goto 56.3,47.5
		.talk Gryan Stoutmantle##234
	...
	step //38
		goto 56.6,52.6|n
		.talk Thor##523
		.' Fly to Stormwind|goto Stormwind City|noway|q 4740 |future
	step //39
		goto Stormwind City,22.6,56.1|n
		.' Ride the boat to Auberdine|goto Darkshore,32.4,43.7,1|noway|q 4740 |future
	step //40
		goto 36.1,44.9
	...
	step //52
		goto 32.9,81.1
		.' Click the Beached Sea Creature
		.info It's a big sea creature skeleton on the beach.
	...
	step //54
		goto 41.4,80.6
		.' Click Buzzbox 525
		.info It's a metal box with levers on it, on the side of the road.
	...
	step //70
		goto 34.4,48|n
		.talk Daelyshia##4267
		.' Fly to Auberdine|goto Darkshore,36.4,45.6,0.3|noway|q 4730
	step //71
		goto Darkshore,36.6,45.6
		.talk Gwennyth Bly'Leggonde##10219
	...
	step //75
		...
		.info They look like stone balls and figurines on the ground around this area.
	step //76
		.' Hearth to Auberdine|goto Darkshore,38.1,43.1,9|use Hearthstone##6948|noway|q 951
	step //77
		goto 43.5,76.3
		.talk Onu##3616
	...
	step //79
		.' Go south to Ashenvale|goto Ashenvale|noway|q 1010
	step //80
	...
	step //94
		ding 23
	step //95
		.' Hearth to Astranaar|goto Ashenvale,35.5,50.2,5|use Hearthstone##6948|noway|q 1023
	step //96
		goto 36.6,49.6
		.talk Raene Wolfrunner##3691
	...
	step //100
		goto 50.1,56.4|n
		.' The path to Shael'dryn starts here|goto Ashenvale,50.1,56.4,0.5|noway|q 1024
	step //101
		goto 53.5,46.3
	...
	step //103
		goto 44.0,55.0|n
		.' The path to 'Elune's Tear' starts here|goto Ashenvale,44.0,55.0,0.5|noway|q 1033
	step //104
		goto 46.2,46
	...
	step //105
		.' Hearth to Astranaar|goto Ashenvale,35.5,50.2,5|use Hearthstone##6948|noway|q 1025
	step //106
		goto 36.6,49.6
		.talk Raene Wolfrunner##3691
	...
	step //109
		goto 37.4,55.2|n
		.' The path to the Ruins of Stardust starts here|goto Ashenvale,37.4,55.2,1|noway|q 1034
	step //110
		goto 33.7,66.5
	...
	step
		...
		.get Divined Scroll##5455|q 1016/1
	step //114
		goto 49.8,67.2
		.talk Sentinel Velene Starstrike##3885
		..turnin Elemental Bracers##1016
	step //115
		.' Go southwest to Talondeep path at|goto Ashenvale,42.3,71.1,3|n
		.' Go through the tunnel to Stonetalon Mountains|goto Stonetalon Mountains,78.2,42.9,3|noway|q 1070
	step //116
	...
	step //126
		goto 36.4,7.2|n
		.talk Teloren##4407
		.' Fly to Astranaar|goto Ashenvale,35.5,50.2,5|noway|q 1134
	step //127
	...
	step //128
		goto 34.4,48|n
		.talk Daelyshia##4267
		.' Fly to Auberdine|goto Darkshore,36.4,45.6,0.3|noway|q 994
	step //129
	...
	step //130
		goto 32.4,43.8|n
		.' Ride the boat to Stormwind Harbor|goto Stormwind City|noway|q 1075
	step //131
	...
	step //132
		goto 71,72.5|n
		.talk Dungar Longdrink##352
		.' Fly to Ironforge|goto Ironforge|noway|q 1072
	step //133
	...
	step //134
		goto 55.5,47.7|n
		.talk Gryth Thurden##1573
		.' Fly to Thelsamar|goto Loch Modan,33.9,50.8,0.5|noway|q 468 |future
	step //135
		goto Loch Modan,34.8,47.1
		.talk Mountaineer Kadrell##1340
	...
	step //137
		.' Go into the tunnel to|goto Wetlands,49.7,79.5
		.kill 8 Dragonmaw Scout##2103|q 455/2
		.kill 6 Dragonmaw Grunt##2102|q 455/3
	step //138
		.' Follow the path through the tunnels|goto 53.9,70.3|n
...
startlevel 25
	...
	step //13
		goto 46.4,35.3
		.from Mosshide Trapper##1011+, Mosshide Brute##1012+, Mosshide Fenrunner##1010+, Mosshide Mistweaver##1009+
	...
	step //15
		.' Hearth to Menethil Harbor|goto Wetlands,10.1,56.7,9|use Hearthstone##6948|noway|q 484
	step //16
		.' Fly to Stormwind|goto Stormwind City|noway|q 9502 |future
		only Draenei Shaman
	step //17
		goto Stormwind City,22.6,56.1
		.' Ride the boat to Auberdine|goto Darkshore,32.4,43.7,1|noway|q 9502 |future
		only Draenei Shaman
	step //18
		.' Ride the boat to Azuremyst Isle|goto Azuremyst Isle|noway|q 9502 |future
		only Draenei Shaman
	step //19
		.' Go northeast to the Exodar|goto The Exodar|noway|q 9502 |future
		only Draenei Shaman
	step //20
		goto The Exodar,32.3,23.9
		.talk Sulaa##17219
	...
	step //21
		...
		only Draenei Shaman
	step //22
		.' Go outside to Azuremyst Isle|goto Azuremyst Isle|noway|q 9501
		only Draenei Shaman
	step //23
		.' Go northeast to Bloodmyst Isle|goto Bloodmyst Isle|noway|q 9501
		only Draenei Shaman
	step //24
	...
	step //25
		...
		.get 6 Foul Essence##23744|q 9503/1
		only Draenei Shaman
	step //26
		goto 32.2,16.3
		.talk Aqueous##17275
		...
		only Draenei Shaman
	step //27
		.' Go southest to Azuremyst Isle|goto Azuremyst Isle|noway|q 9504
		only Draenei Shaman
	step //28
		.' Go southwest to ride the boat to Auberdine|goto Darkshore,32.8,42.0,9|noway|q 9504
		only Draenei Shaman
	step //29
		.' Fly to Astranaar|goto Ashenvale,35.5,50.2,5|noway|q 9504
		only Draenei Shaman
	step //30
		...
		.get Filled Bota Bag##23750|q 9504/1
		only Draenei Shaman
	step //31
		.' Go north to Astranaar and fly to Auberdine|goto Darkshore,36.4,45.6,0.3|noway|q 9504
		only Draenei Shaman
	step //32
		.' Ride the boat to Azuremyst Isle|goto Azuremyst Isle|noway|q 9504
		only Draenei Shaman
	step //33
		.' Go northeast to Bloodmyst Isle|goto Bloodmyst Isle|noway|q 9504
		only Draenei Shaman
	step //34
		goto Bloodmyst Isle,32.2,16.3
		.talk Aqueous##17275
	...
	step //35
		...
		.get Head of Tel'athion##23997|q 9508/1
		only Draenei Shaman
	step //36
		goto 32.2,16.3
		.talk Aqueous##17275
		...
		only Draenei Shaman
	step //37
		.' Go southeast to Azuremyst Isle|goto Azuremyst Isle|noway|q 9509
		only Draenei Shaman
	step //38
		.' Go southwest to the Exodar|goto The Exodar|noway|q 9509
		only Draenei Shaman
	step //39
		...
		only Draenei Shaman
	step //40
		.' Go outside to Azuremyst Isle|goto Azuremyst Isle|noway|q 484
		only Draenei Shaman
	step //41
		.' Go southwest to ride the boat to Auberdine|goto Darkshore,32.8,42.0,9|noway|q 484
		only Draenei Shaman
	step //42
		.' Ride the boat to Stormwind Harbor|goto Stormwind City|noway|q 484
		only Draenei Shaman
	step //43
		.' Fly to Menethil Harbor|goto Wetlands,9.5,59.7,0.5|noway|q 484
		only Draenei Shaman
	step //44
	...
	step //68
		goto 71.7,41.6
		.from Shadowhide Darkweaver##429+, Shadowhide Slayer##431+, Shadowhide Brute##432+, Shadowhide Gnoll##433+, Rabid Shadowhide Gnoll##434+, Shadowhide Warrior##568+
	...
	step //80
		.' Hearth to Lakeshire|goto Redridge Mountains,26.9,44.9,0.5|use Hearthstone##6948|noway|q 180
	step //81
		goto 30,44.4
		.talk Magistrate Solomon##344
		..turnin Wanted: Lieutenant Fangore##180
	step //82
		.' Go southwest to Duskwood|goto Duskwood|noway|q 101 |future
	step //83
	...
	step //99
		.' Go northwest to Stormwind|goto Stormwind City|noway|q 70
	step //100
	...
	step //102
		.' Go outside to Elwynn Forest|goto Elwynn Forest|noway|q 74
	step //103
	...
	step //106
		.' Hearth to Darkshire|goto Duskwood,73.9,44.5,0.5|use Hearthstone##6948|noway|q 78
	step //107
	...
	step //111
		...
		.' Run up the hill behind the town hall building|goto Duskwood,70.2,45.1,0.5|noway|q 173
	step //112
		goto 66,47
	...
	step //133
		.' Hearth to Darkshire|goto Duskwood,73.9,44.5,0.5|use Hearthstone##6948|noway|q 5
	step //134
		goto 73.8,43.5
		.talk Chef Grual##272
	...
	step //159
		.' Hearth to Darkshire|goto Duskwood,73.9,44.5,0.5|use Hearthstone##6948|noway|q 156
	step //160
		goto 74.1,44.7
		.talk Tavernkeep Smitts##273
	...
	step //170
		.' Hearth to Darkshire|goto Duskwood,73.9,44.5,0.5|use Hearthstone##6948|noway|q 160
	step //171
		goto 71.9,46.4
...
startlevel 30
	...
	step //30
		goto 77.5,44.3|n
		.talk Felicia Maline##2409
		.' Fly to Stormwind|goto Stormwind City|noway|q 1026
	step //31
		goto Stormwind City,22.6,56.1|n
		.' Ride the boat to Auberdine|goto Darkshore,32.4,43.7,1|noway|q 1026
	step //32
		goto Darkshore,36.3,45.6|n
		.talk Caylais Moonfeather##3841
		.' Fly to Astranaar|goto Ashenvale,35.5,50.2,5|noway|q 1026
	step //33
		goto Ashenvale,37.0,49.2
		.talk Innkeeper Kimlya##6738
		home Astranaar|q 1026
	step //34
		goto Ashenvale,54.97,33.85
		.from Withered Ancient##3919+, Crazed Ancient##3834+
		.collect Wooden Key##5475|q 1026
		.' You can find more Ancient|at 57.85,33.65
	step
		goto Ashenvale,54.4,35.4
		.collect Iron Shaft##5464|q 1026/1
		.info A small chest on a stone pedestal.
	step //35
		goto 50.1,56.4|n
		.' The path to Shael'dryn starts here.|goto Ashenvale,50.1,56.4,0.5|noway|q 1026
	step //36
		goto 53.5,46.3
		.talk Shael'dryn##3916
	...
	step //51
		...
		.info A bottle lying on the table.
	step //52
		goto 74.1,73.6
		.from Rotting Slime##3928+
		.info A small chest appears near it after death.
	...
	step //55
		goto 53.4,33.2|n
		.' The path up to 'The Howling Vale' starts here|goto Ashenvale,53.4,33.2,0.5|noway|q 1022
	step //56
		goto 50.5,39.1
	...
	step //65
		.' Go east to Azshara|goto Azshara|noway|q 1035
	step //66
		goto Azshara,11.9,77.6
		.talk Jarrodenus##12577
		.fpath Talrendis Point
	step //67
		goto Azshara,11.9,77.6|n
		.talk Jarrodenus##12577
		.' Fly to Astranaar|goto Ashenvale,35.5,50.2,5|noway|q 1035
	step //68
	...
	step //69
		goto 50.1,56.4|n
		.' The path to Shael'dryn starts here.|goto Ashenvale,50.1,56.4,0.5|noway|q 1027
	step //70
		goto 53.5,46.3
		.talk Shael'dryn##3916
	...
	step //71
		goto 56.0,51.4|n
		.' The path up to 'Raene's Cleansing (6)' starts here|goto Ashenvale,56.0,51.4,0.5|noway|q 1028
	step //72
		goto 56.4,49.2
	...
	step //74
		.' Hearth to Astranaar|goto Ashenvale,35.5,50.2,5|use Hearthstone##6948|noway|q 1029
	step //75
		goto 36.6,49.6
		.talk Raene Wolfrunner##3691
	...
	step //76
		goto 34.4,48|n
		.talk Daelyshia##4267
		.' Fly to Auberdine|goto Darkshore,36.4,45.6,0.3|noway|q 1037
	step //77
		goto Darkshore,33.2,40.05|n
		.' Ride the boat to Rut'theran Village|goto Teldrassil,56.3,92.4,6|noway|q 1037
	step //78
	...
	step //79
		goto Teldrassil,55.95,89.75|n
		.' Go through the big pink portal to Darnassus|goto Darnassus|noway|q 1037
	step //80
	...
	step //81
		...
		.info Over the bridge on the second floor of the building. It is a chest on the ground.
	step //82
		goto 61.8,39.2
		.talk Thyn'tel Bladeweaver##8026
	...
	step //83
		goto Darnassus,30.55,41.35|n
		.' Go to Rut'theran Village|goto Teldrassil,56.3,92.4,6|noway|q 1301 |future
	step //84
		goto Teldrassil,58.4,94|n
		.talk Vesprystus##3838
		.' Fly to Auberdine|goto Darkshore,36.4,45.6,0.5|noway|q 1301 |future
	step //85
		goto Darkshore,32.35,43.95|n
		.' Ride the boat to Stormwind Harbor|goto Stormwind City|noway|q 1301 |future
	step //
		goto Stormwind,51.1,95.5
		.talk Connor Rivers##5081
		..accept James Hyal (1)##1301
	step //86
		.goto Stormwind,71,72.5|n
		.talk Dungar Longdrink##352
		.' Fly to Menethil Harbor|goto Wetlands,9.5,59.7,0.5|noway|q 1301
	step //87
	...
	step //90
		goto 10.7,61.0
		.talk Innkeeper Helbrek##1464
		home Menethil Harbor|q 321
	step //91
		goto 12.1,64.2
		.' Interact with gameobject: Waterlogged Chest
		.info It's a brown chest sitting on this tiny island between 2 broken ship halves.
	...
	step //105
		.' Hearth to Menethil Harbor|goto Wetlands,10.1,56.7,9|use Hearthstone##6948|noway|q 292
	step //106
		goto 10.6,60.6
		.talk Glorin Steelbrow##1217
	...
	step
		...
		.' You can find more around|at 47.2,16.45
	step //110
		goto 49.8,18.3
		.talk Longbraid the Grim##1071
	...
	step //113
		.' Go north to the Arathi Highlands|goto Arathi Highlands|noway|q 633
	step //114
	...
	step //115
		.' Go south to the Wetlands|goto Wetlands|noway|q 633
	step //116
	...
	step //117
		.' Go north to the Arathi Highlands|goto Arathi Highlands|noway|q 634
	step //118
	...
	step //119
		...
		.fpath Refuge Pointe
	step //120
		.' Go northwest to the Hillsbrad Foothills|goto Hillsbrad Foothills|noway|q 555 |future
	step //121
	...
	step //142
		.' Go north to the Alterac Mountains|goto Alterac Mountains|noway|q 564
	step //143
	...
	step //146
		.' Hearth to Southshore|goto Hillsbrad Foothills,51.2,58.9,0.5|use Hearthstone##6948|noway|q 9435
	step //147
	...
	step //151
		goto 49.3,52.3|n
		.talk Darla Harris##2432
		.' Fly to Refuge Point|goto Arathi Highlands,45.8,46.1,0.5|noway|q 681
	step //152
	...
	step //154
		goto 45.8,46.1|n
		.talk Cedrik Prose##2835
		.' Fly to Ironforge|goto Ironforge|noway|q 1179 |future
	step //155
	...
	step //158
		goto 55.5,47.7|n
		.talk Gryth Thurden##1573
		.' Fly to Stormwind|goto Stormwind City|noway|q 563
	step //159
	...
	step //166
		goto 71,72.5|n
		.talk Dungar Longdrink##352
		.' Fly to Darkshire|goto Duskwood,74.7,46.9,7|noway|q 583 |future
	step //167
		.' Go southwest to Stranglethorn Vale|goto Stranglethorn Vale|noway|q 583 |future
	step //168
	...
	step //184
		goto 25.8,73.1|n
		.' Ride the boat to Ratchet|goto The Barrens|noway|q 1039
	step //185
	...
	step //186
		...
		.fpath Ratchet
	step //187
		.' Go southwest to Thousand Needles|goto Thousand Needles|noway|q 1100 |future
	step //188
	...
	step //198
		...
		.get 9 Hardened Tortoise Shell##5795|q 1105/1
	step //199
		goto 75.4,55
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Leveling Guides\\Levels (50-55)", [[
	...
	step //224
	    goto 32.4,43.8
		.talk Quintis Jonespyre##7879
		.turnin Jonespyre's Request(1)##3787
		.accept The Mystery of Morrowgrain##3791
	step //225
	    .collect 10 Un'Goro Soil##11018
		.collect 5 Packet of Tharlendris Seeds##11022
	    .use Evergreen Pouch##11020
	    .collect 5 Evergreen Herb Casing##11024
		.use Evergreen Herb Casing##11024
	    .collect 10 Morrowgrain|q 3791/1
		.turnin The Mystery of Morrowgrain##3791
	step //226
		'Ride the boat to the main continent of Feralas|goto Feralas,43.5,42.7,1|noway|c
	step //227
		goto 45.1,25.6
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Leveling Guides\\Northrend (78-80)", [[
	...
	step //169
		...
		//.get 6 Vial of Frost Oil##41612|q 12925
		.collect 6 Vial of Frost Oil##41612
	step //170
		goto 23.7,58.3
